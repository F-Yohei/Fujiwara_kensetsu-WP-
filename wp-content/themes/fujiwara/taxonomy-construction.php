        ...
        <nav class="c-breadcrumbs" aria-label="breadcrumb">
            <div class="l-container">
                <ol class="c-breadcrumbs__list">
                    ...
                    <li class="c-breadcrumbs__item">
                        <a href="<?php echo esc_url(home_url('works')); ?>" class="c-breadcrumbs__link"
                            aria-current="page">施工実績</a>
                    </li>
                </ol>
            </div>
        </nav>
            ...
            <div class="l-container">
                <nav class="c-archive-nav">
                    ...
                    <ul class="c-archive-nav__list">
                        <li class="c-archive-nav__item">
                            <a href="<?php echo esc_url(home_url('works')); ?>" class="c-archive-nav__link">全て</a>
                        </li>
                        <?php
                        $taxonomies = array(
                            'construction'
                ...
                <div class="p-works-archive__inner">
                    <ul class="p-works-archive__list">
                        <?php
                        $type = get_query_var('construction');
                        $args = array(
                        ...
                        <li class="p-works-archive__item">
                            <a href="<?php the_permalink(); ?>" class="p-works-archive__link">
                                <figure>
                                    ...
                                    <span class="p-works-archive__tag <?php
