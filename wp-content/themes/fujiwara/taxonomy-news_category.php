    ...
    <article class="l-section">
        <div id="js-top" class="p-hero">
            ...
            <figure class="js-parallax-hero">
                <picture>
                    <source srcset="<?php echo do_shortcode('[theme_url]'); ?>/assets/images/news/hero_img_pc.jpg"
                        media="(min-width: 769px)" type="image/jpg" />
                    <img src="<?php echo do_shortcode('[theme_url]'); ?>/assets/images/news/hero_img_sp.jpg" alt="" />
                </picture>
            </figure>
        </div>
